...
// }
         ...
         using namespace std;                    //we use {&}  operator for reference  the value by different point .
    // #include<iostream>
    // using namespace std;
    ...
    // }    
         ...
         int main(){
            ...
            cout<<"the convert to float :"<<int(a)<<endl;
            cout<<"the convert to float :"<<float(r)<<endl;
            return 0;
         }      
        ...
        int main(){
            ...
            // }
                   ...
                   {                                            /*yaha par {break} statement ka use isliye hua [switch case] mei kyuki agar jase hi agar koi swith case pura 
                                                          tuh turant break hoke bahar aa jaye aur program wahi khatam ho jaye...lekin agar ham break statement nahi 
                                              lagate h tuh wo sara switch case statement wo ek saath excuet ho jayega output */
                    case 22:

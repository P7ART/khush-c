...
int main(){
    ...
    do{
       ...
       i++;
       i++;
    }while(true);// isme [do while loop] aap condition koi bhi condition do true ya false wo ek baar bina condtion check kare  loop chala dega usske baad fir wo condition dekh ke chalayega.

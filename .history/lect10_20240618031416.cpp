...
int main(){
    ...
    do{
       cout<<i<<endl;
       i++;
    }while(i<=40);// isme [do while loop] aap condition koi bhi condition do true ya false wo ek baar bina condtion check kare  loop chala dega usske baad fir wo condition dekh ke chalayega

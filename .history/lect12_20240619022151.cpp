...
int main() {
    ...
    //Pointer to Pointer
    //Pointer to Pointer is a simple concept, in which we store the address of one Pointer to another point.matlab hamne jo pointer assign kiya tha tuh usski bh

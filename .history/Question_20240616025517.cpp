...
Write a program to classify a student's marks into grades (A, B, C, D, E) based on predefined ranges using a chained if-else ladder.
        ...
        */
         #include<iostream>
          ...
          /*Question5 nput Validation Using if-else:
Develop a program that prompts the user to enter an integer between 1 and 10. Use an if-else statement to validate the input and ask again if the input is out of range.
          */